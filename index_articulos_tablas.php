            ...
            <?php if (Session::existe()): ?>
                ...
                <div id="usuario"> 
                    <div class="usuario">
                        ...
                        <br><?= $usuario->getNombre() ?><br>
                        <a href="logout.php">cerrar sesión</a>
                    </div>
                    <br><br>
                    <p style="font-style: italic ; font-size: 1.5em;"> Lista de Articulos:</p>
                    <div class="tablaArticulos">
                        <table class="display" id="tablaArticulos">
                            <thead>
                            <td>ID</td>
                            <td>Titulo</td>
                            <td>Descripcion</td>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($articulos as $row) { ?>       <!-- importantes las llaves de apertura del while  -->
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><a href='javascript:mostrarEditar(<?php echo json_encode($row) ?>)'><button >Editar</button></a>
                                        <a href="eliminarArticulos.php?id=<?php echo $row['id']; ?>" ><button>Borrar</button></a></td>
                                    </tr> 
                    ...
                    <form action="modificarArticulos.php" method="POST" style="display:none;" id="editarForm">
                        <h2>Editar articulo existente</h2>   
